...
function validinput(){
  ...
  if(regex.test(gname.value)==true&&regex.test(gurl.value)==true){
    ...
    document.getElementById("alarm").classList.replace("d-none" ,"d-flex")
  
  return false;

}
function gclose(){
  document.getElementById("alarm").classList.replace("d-flex","d-none")
...
function displaydata(){
  ...
  for(var i=0;i<alldata.length;i++){
     ...
     cartoona += `<tr>
              ...
              <td>
                <button class="btn btn-visit" data-index="0" onclick="visitWebsite()">
                  <i class="fa-solid fa-eye pe-2"></i>Visit
                </button>
              </td>
              <td>
                <button class="btn btn-delete pe-2" data-index="0" onclick="deletev(${i})">
